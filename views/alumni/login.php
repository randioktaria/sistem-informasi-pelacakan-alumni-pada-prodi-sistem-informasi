	...
	<div class="container">
		<div class="card card-login mx-auto mt-5 shadow">
			<div class="card-header text-white" style="background-color: #17a2b8">
				...
				<div class="card-body">
					<form method="POST" action="<?php echo url.'secure/login' ?>">
						<div class="form-group">
						  <label for="username">Username</label>
						  <input class="form-control" type="text" placeholder="Username / Nobp" name="username" required>
						</div>
						...
						<center>
						  <input type="submit" name="login" value="Login" class="btn btn-md text-white" style="background-color: #17a2b8;">
						</center>
					</form>
				</div>
      </div>
